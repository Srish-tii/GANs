...
Original file is located at
    https://colab.research.google.com/drive/1VN8SJm6u0uF0fYVhrQPD3MbYmO4vp7ce
"""
...
for epoch in range(epochs):
    ...
    save_generator_image(generated_img, f"new_loss_gen_img{epoch+1}.png")
...
print('DONE TRAINING')
torch.save(generator.state_dict(), 'new_loss_generator.pth')

# save the generated images as GIF file
imgs = [np.array(to_pil_image(img)) for img in images]
imageio.mimsave('new_loss_generator_images.gif', imgs)
